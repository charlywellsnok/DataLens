# Web Development Project 5 - *DataLens*

Submitted by: **Charlotte Kathlyn Naa Odarley Wellington**

This web app: **InsightHub is a modern data dashboard that transforms real-time environmental data into meaningful insights. It provides key temperature statistics, searchable records, and interactive filters, enabling users to quickly explore trends and better understand changing weather conditions.**
